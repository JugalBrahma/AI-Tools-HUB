...
class _ScrollRevealState extends State<ScrollReveal> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return VisibilityDetector(
      key: Key(identityHashCode(widget).toString() + widget.child.runtimeType.toString()),
      onVisibilityChanged: (info) {
        // Trigger when at least 20% of the widget is visible
        ...
        builder: (context, child) {
          return Opacity(
            ...
            child: Transform.translate(
              offset: _slide.value * 100.0, // Increased travel distance for better effect
              child: child,
            ),
          );
        },
